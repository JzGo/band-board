...
class MemberTest < ActiveSupport::TestCase
  ...
  test "Member is not saved if email not provided" do
    member1 = Member.new(membername: "Mel", password: "12344321")
    assert_not(member1.valid?, "Member is valid without email")
  end

  test "Member is not saved if membername to provided" do
  ...
  test "Member is not saved if password not provided" do
    member3 = Member.new(membername: "Mel", email: "member3@example.com")
